        ...
        <div className="col-span-7 place-self-center">
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            <button className=" p-1 w-fit sm:w-fit rounded-full mr-4 mb-4 sm:mb-0 cursor-pointer relative group overflow-hidden border-2 px-8 py-2 border-[#EEE600]" >
              <a href={"https://drive.google.com/file/d/1n9dtL6_jWtt-ELFWH2q8w3aISoE0_FxX/view?usp=drive_link"} target="_blank" rel="noopener noreferrer" download="nombre_pretendido_del archivo.pdf">
